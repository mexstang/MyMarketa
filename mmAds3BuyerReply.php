...
<textarea  id='messageBox'  
 required maxlength='100'  rows='5' cols='50'   wrap='hard'  readonly style='background:#DDE5DC;color:black;border:outset;font-size:17px;border-radius:3px;' >$sellerMessage1</textarea>
 <br/> 
