...
$message =$title."\n". "Hello.\nPlease click to activate your AD."."\n".
"https://www.mimarketa.com/mmMain/mmEnglish/mmAdsPortal.php?pw=".$clave."\n"."PASSWORD: ".$clave;
$headers = "From:" . $from;
...
$subject2 = "ALERT!  MyMarketa.com AD has been added!  ".$title.$to;
$message2 = "ALERT!  MyMarketa.com AD has been added!  ".$title;
$headers2 = "From:" . $from2;
