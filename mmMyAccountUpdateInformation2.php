...
$sql1 ="
UPDATE $lasCuentasTable SET userName='$username2', city='$city' , clave='$clave'   WHERE ecorreo = '$ecorreo'  ";
...
echo "<script>
alert('SUCCESS! Info Updated. No Pic Change.'); 
 window.close();
 </script>";
...
UPDATE $lasCuentasTable SET userName='$username2', userPic='$picUrl1', 
 city='$city'  , clave='$clave'   WHERE ecorreo = '$ecorreo' 
";
